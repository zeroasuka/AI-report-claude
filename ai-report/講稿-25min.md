...
> **變更說明**：原 P8「Skill/Hook/Cron」已移除（純概念、無 demo、與 Codex 拆解重疊）；新增 Agenda 頁（+35s）。一加一減後總頁數仍為 32 頁。

**合計 ≈ 1423 秒 ≈ 23.7 分鐘**（含 Agenda、已扣除 P8）
...
（補一句）順帶一提，**今天這份簡報，就是用一個叫 `html-ppt` 的 skill 做的**——一行指令就裝好版型跟動畫，這就是「把專業包交給 Agent」最現成的例子。
...
- **三段影片（P6／P24／P28）是節奏關鍵**——讓影片自己講，你只起頭 + 收尾，別在播放時蓋話。三段影片合計約 3 分鐘，邊播邊講等於講兩次、直接爆時間。
...
**鐵則一：影片頁閉嘴**
P6／P24／P28 三段影片，按下播放後**完全不講話**，只在影片前丟一句起頭、影片後丟一句收尾。這一條守住，就省回 2～3 分鐘。

**鐵則二：⏩ 頁就是一句話 + 翻頁，不准展開**
P9、P11、P12、P14、P18、P22、P25 ——每頁**唸完講稿那一句立刻按下一頁**，不補充、不舉例、不回頭。手指比嘴巴快。

**鐵則三：核心頁也要收**
P7（聊天室 vs 執行助理）、P20（Gemini→規格書）、P27（追星故事）是你最容易「講上癮」的三頁。給自己**硬上限**：
- P7 → 最多 70 秒，講完「一次跑完、產出能用的成品」就走。
- P20 → 最多 70 秒，三步驟各一句，重點落在「省 token」那句。
- P27 → 最多 70 秒，故事講到「只差五分鐘」+ 影片即可，別補生平。

**鐵則四：自我檢查點**
心裡記三個錨點，到點還沒到就立刻啟動「一句帶過」模式：
- 講完 **P6 Typeless 影片** → 該在第 5 分鐘
- 講完 **P18 Case01** → 該在第 13 分鐘
- 講完 **P25 Case03** → 該在第 19 分鐘
