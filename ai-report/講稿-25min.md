...
> **版本說明**：本稿對應 HTML 30 頁版（P16 解法頁已合併、P22 雙版頁已刪除）。
...
| 1 | 封面 言出法隨 | 講 | 40s |
| 2 | 自我介紹 | 講（精簡） | 50s |
| 3 | Agenda 今天的五段路 | 講 | 35s |
| 4 | 打字 vs 說話 45/220 | 講 | 50s |
| 5 | Typeless 三步驟 | 講 | 55s |
| 6 | Typeless 演示影片 | ▶️ 播片 | 60s |
| 7 | 從聊天，到執行（比較卡） | 講 | 70s |
| 8 | 想→寫→做 三段工作流 | 講（精簡） | 55s |
...
| 13 | 五層工作流 | 講（精簡） | 45s |
| 14 | 方法可遷移 | ⏩ 一句帶過 | 15s |
| 15 | Case01 PN 痛點（匯入→查料→物流） | 講 | 50s |
| 16 | Case01 解法＋iframe demo（合頁） | 講 | 60s |
...
**合計 ≈ 1430 秒 ≈ 23.8 分鐘**（30 頁，留 1 分鐘緩衝）
...
## 【P3 · Agenda · 今天的五段路】　⏱ 35s

在正式開始之前，先給各位一張「地圖」，今天這 25 分鐘會帶你走過五段路：

1. **用「說」的取代「打」的**——語音輸入，把鍵盤變成備胎。
2. **別把 AI 當聊天室**——規格書 + Agent 工作流，想、寫、做。
3. **三個真實案例**——查料號 App、成都旅遊助手、讓 AI 自己修電腦。
4. **不只是工具，是助理**——Hermes 跟 OpenClaw，24 小時待命、我講它做。
5. **你的第一步**——本週你就能試的三件事。

放心，前面是觀念、中間是實戰、後面是行動。聽到一半如果覺得「這跟我有什麼關係」，撐到第三段，案例會說服你。我們開始。
...
## 【P11 · 6 種核心模組】　⏱ 15s　⏩ 一句帶過

Agent 圍繞 Model 有六種核心模組——Prompt、Skill、Markdown、AGENTS.md、Memory、MCP——這些都是幫 AI 建立上下文（Context）用的。讓 AI 知道要做什麼、怎麼做、記住什麼、從哪裡取資料。細節留給線上版慢慢看。
...
第一個案例，從我每天的工作講起。Part Number 散落在文件和 Email 裡，我的痛點是三件事：第一，**PN 要能快速找到**；第二，**找到要能快速貼回公司內部查料系統**；第三，**還要整理出料的物流資訊**——收件人、地址、電話、備註。

舊流程每一步都要手動，繁瑣、容易出錯。而且老實說，**這件事我以前覺得「沒辦法」**——因為我不是工程師，不會 React、不會後端、不會部署。我以為這種工具，輪不到我自己做。

---

## 【P16 · Case01 · 解法 + Demo】　⏱ 60s

結果呢？**一段需求就搞定。**

我用 Typeless 講了大概幾十個字：「Part Number 常出現在文件和 Email 裡，我想先匯入 PN，再快速搜尋和複製。關鍵字不完整也要找得到。還要產生出料物流需要的收件資訊。」

Codex 就自己把 FastAPI 後端、前端、模糊搜尋、一鍵複製、物流資訊欄位一條龍寫完，還加了密碼保護給同事用。右邊就是成品——現在每天在線，我跟同事都在用。
...
成果一句話：智慧搜尋、一鍵複製、自動帶出出料物流資訊——**vibe coding 把「我以為做不到的工具」，變成「用說的就能擁有的工具」。**
...
地圖整合、行程編輯、熊貓 UI 全都有。當你發現自己五小時就能做一個完全合用的 App，「買軟體訂閱」這件事，你就會重新思考。各位可以掃右邊這個 QR，在手機上實際操作看看。
...
我沒有自己一班一班查，我請 OpenClaw 幫我找。看左邊這兩張航班卡：aespa 搭韓亞航空 OZ114，從首爾飛大阪，18:30 落地；而我搭德威航空 TW313，從大邱飛大阪，18:25 落地——**同一個機場、同一個入境口，只差五分鐘。**

OpenClaw 做的事：即時查當下落地的所有航班、自動排除廉航、幫我鎖定 aespa 那班。中間這個影片，就是我在大阪機場現場，**真的遇到 aespa** 的畫面。右邊是 OpenClaw 查到的截圖。
...
- **三段影片（P6／P22／P26）是節奏關鍵**——讓影片自己講，你只起頭 + 收尾，別在播放時蓋話。三段影片合計約 3 分鐘，邊播邊講等於講兩次、直接爆時間。
- **P25 OpenClaw 頁**：影片直接嵌在頁面中欄，不需要另外操作播放器，講完故事後直接點中間影片播即可。
- **真正可砍的緩衝**：P11、P12、P14、P17、P23 這五頁都是「一句帶過」，現場時間緊就用翻頁速度過，省 1～1.5 分鐘。
- **若超時**：優先再砍 P8（想寫做）和 P13（五層工作流），P7 已經把核心概念講過，這兩頁是延伸。
- **若還有餘裕**：P20 成品、P25 追星故事可以多講 10～20 秒，這兩個最有記憶點。
...
**鐵則二：⏩ 頁就是一句話 + 翻頁，不准展開**
P9、P11、P12、P14、P17、P23 ——每頁**唸完講稿那一句立刻按下一頁**，不補充、不舉例、不回頭。手指比嘴巴快。

**鐵則三：核心頁也要收**
P7（聊天室 vs 執行助理）、P19（Gemini→規格書）、P25（追星故事）是你最容易「講上癮」的三頁。給自己**硬上限**：
- P7 → 最多 70 秒，講完「一次跑完、產出能用的成品」就走。
- P19 → 最多 70 秒，三步驟各一句，重點落在「省 token」那句。
- P25 → 最多 70 秒，故事講到「只差五分鐘」+ 影片即可，別補生平。

**鐵則四：自我檢查點**
心裡記三個錨點，到點還沒到就立刻啟動「一句帶過」模式：
